...
ActiveRecord::Schema.define(version: 20161223232204) do
  ...
  create_table "product_subscriptions", force: :cascade do |t|
    ...
    t.index ["subscription_id"], name: "index_product_subscriptions_on_subscription_id"
  end
  ...
  create_table "product_transactions", force: :cascade do |t|
    ...
    t.index ["transaction_id"], name: "index_product_transactions_on_transaction_id"
  end
